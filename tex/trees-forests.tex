...
For the cube graph in three dimensions 
(shown in Figure
\ref{fig:trees-forests:cube3-graph-example}), and for the 
Desargues graph (shown in Figure
\ref{fig:trees-forests:desargues-graph-example}), the undirected
analog of Theorem \ref{thrm:rank-cutset_matrix}
does hold.
...
On the other hand, for the Frucht graph
(shown in Figure
\ref{fig:trees-forests:frucht-graph-example}),
