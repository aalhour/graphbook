...
\begin{example}
\label{example:graph-coloring:frucht-graph-vertex-coloring-example}
A Frucht graph, 
shown in Figure
\ref{fig:graph-coloring:frucht-graph-vertex-coloring-example},
...
\label{fig:graph-coloring:frucht-graph-vertex-coloring-example}
\end{figure}
