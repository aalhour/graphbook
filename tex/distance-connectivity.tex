...
The {\it closeness centrality} is defined to be 
...
its~(vertex) \emph{Laplacian matrix}\index{Laplacian matrix}
...
\index{Cayley graph of Boolean function}
...
\cite{Stanica2007}, \cite{Bernasconi1998},
\cite{BernasconiEtAl1999}, \cite{BernasconiEtAl2001}.

First, consider the Boolean function $f: GF(2)^4 \to GF(2)$ 
given by $f(x_0,x_1,x_2) = x_0x_1+x_2x_3$.
...
Let us use Sage to determine some properties of this graph.
...
The picture of the graph is given in Figure \ref{fig:distance_connectivity:bent-fcns-cayley-graphs1}.
...
The Hadamard transform of the Boolean function
does indeed determine the spectrum of its Cayley graph.

Here is another example: $f: GF(2)^3 \to GF(2)$ given by 
$f(x_0,x_1,x_2) = x_0x_1+x_2$.
...
....:
sage: L1; L2
[2, 0, 2, 2, 2, 2, 0, 2, 2, 2, 0, 2, 2, 2, 2, 0, 0, 2, 2, 2, 
...
(There are other reasons why $f$ cannot be bent as well.)
Again, let us use Sage to determine some properties of this graph.
...
%%% this needs references, more examples, and proofs
...
\index{vertex!expansion}
\index{isoperimetric number}
\index{vertex!isoperimetric number}
